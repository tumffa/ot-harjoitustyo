...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivinen_lataa_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-10)

        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def test_pystyy_ostamaan_edullisen_kun_sen_verran_raha(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0)

    def test_pystyy_ostamaan_maukkaan_kun_sen_verran_raha(self):
